...
<head>
    ...
    <body class="authentication-bg authentication-bg-pattern"  background="bg-pattern.jpg">
                        ...
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    <a href="index.php">
                                        <span><img src="assets/images/ourlogo.png" alt="" height="75"></span>
                                    </a>
                                    <p class="text-muted mb-4 mt-3">Enter your email address and password to access Hospital panel.</p>
                                </div>
