	...
	include('assets/inc/config.php');
		if(isset($_POST['update_doc']))
		{
			...
			*/ 
			...
			if($stmt)
			{
				$success = "Hospital Details Updated";
			}
			else {
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Update Hospital Details</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label for="inputAddress" class="col-form-label">Hospital Email</label>
                                            ...
                                            <button type="submit" name="update_doc" class="ladda-button btn btn-success" data-style="expand-right">Add Hospital</button>
