                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <?php
                                                    ...
                                                    $result ="SELECT count(*) FROM his_patients WHERE pat_type = 'Critical Care beds' ";
                                                    ...
                                                    $stmt->close();
                                                ?>
                                                <h3 class="text-dark mt-1"><span data-plugin="counterup"><?php echo 1009;?></span></h3>
                                                <p class="text-muted mb-1 text-truncate">Total Critical Care Beds</p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <?php
                                                    ...
                                                    $result ="SELECT count(*) FROM his_patients WHERE pat_type = 'Long-Term Care beds' ";
                                                    $stmt = $mysqli->prepare($result);
                                                    $stmt->execute();
                                                    ...
                                                    $stmt->close();
                                                ?>
                                                <h3 class="text-dark mt-1"><span data-plugin="counterup"><?php echo 1859;?></span></h3>
                                                <p class="text-muted mb-1 text-truncate">Total long-term care beds</p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                </div> <!-- end widget-rounded-circle-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                ...
                                                <p class="text-muted mb-1 text-truncate">Number of Hospitals </p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                </div> <!-- end widget-rounded-circle-->
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card-box">
                                    <h4 class="header-title mb-3">Hospitals Data</h4>
