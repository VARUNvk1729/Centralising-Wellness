                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li>
                                        <a href="his_admin_register_patient.php">Register Beds</a>
                                    </li>
                                    <li>
                                        <a href="his_admin_view_patients.php">View Beds</a>
                                    </li>
                                    <li>
                                        <a href="his_admin_manage_patient.php">Manage Beds</a>
                                    </li>
                                    <hr>
                                    <!-- <li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li>
                                        <a href="his_admin_add_employee.php">Add Hospital</a>
                                    </li>
                                    <li>
                                        <a href="his_admin_view_employee.php">View Hospitals</a>
                                    </li>
                                    <li>
                                        <a href="his_admin_manage_employee.php">Manage Hospitals</a>
                                    </li>
                                    <hr>
                                    <!-- <li>
                            ...
                            <!-- <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li>
                                        <a href="his_admin_add_ acc.payable.php">Add Acc. Payable</a>
                                    </li>
                                    <li>
