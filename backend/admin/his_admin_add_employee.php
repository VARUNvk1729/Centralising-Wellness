	...
	include('assets/inc/config.php');
		if(isset($_POST['add_doc']))
		{
			...
			*/ 
			...
			if($stmt)
			{
				$success = "Hospital Details Added";
			}
			else {
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Add Hospital Details</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            ...
                                            <button type="submit" name="add_doc" class="ladda-button btn btn-success" data-style="expand-right">Add Hospital</button>
