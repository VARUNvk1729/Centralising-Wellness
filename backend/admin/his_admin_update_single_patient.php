                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Update Bed Details</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="inputPassword4" class="col-form-label">Number of Beds</label>
                                            ...
                                            <div class="form-group">
                                                <label for="inputAddress" class="col-form-label">Occupancy of beds</label>
                                            ...
                                            <button type="submit" name="update_patient" class="ladda-button btn btn-success" data-style="expand-right">Add Bed Details</button>
